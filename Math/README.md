...
## 📌 Overview
Mathematical problems test concepts in number theory, combinatorics, modular arithmetic, and numerical algorithms.

## 🛠️ Common Patterns & Techniques
- Greatest Common Divisor (GCD) / LCM (Euclidean Algorithm)
- Prime Testing & Sieve of Eratosthenes
